...
public class UsuarioControle {
	...
	public ResponseEntity<?> cadastrarUsuario(@RequestBody Usuario usuario) {
		...
		try {
			VerificarCamposFaltantesNoUsuario(usuario);
		} catch (Exception ex) {
	...
	private void VerificarCamposFaltantesNoUsuario(Usuario usuario){
		...
		if(usuario.getNomeSocial() == null || usuario.getNomeSocial().isEmpty()){
			throw new RuntimeException("Nome social do usuário não pode ser vazio");
		}

		if(usuario.getPerfis() == null || usuario.getPerfis().isEmpty()){
			throw new RuntimeException("Perfis do usuário não pode ser vazio");
		}


		if(usuario.getDocumentos() == null || usuario.getDocumentos().isEmpty()){
			throw new RuntimeException("Documentos do usuário não pode ser vazio");
		}


		if(usuario.getCredencial() == null){
			throw new RuntimeException("Credencial do usuário não pode ser vazio");
		}

		if(usuario.getEmpresa() == null){
			throw new RuntimeException("Empresa do usuário não pode ser vazio");
		}
