...
public class ServicoControle {
	...
	public ResponseEntity<?> obterServico(@PathVariable long id)
	{
		...
		if(servico == null){
			...
			var dto = ServicoSimplesDTO.from(servico);
			adicionadorLinkServico.adicionarLink(dto);
	...
	public ResponseEntity<?> obterServicos() {
		...
		if(servicos.isEmpty()){
			...
			var dtos = ServicoSimplesDTO.from(servicos);
			adicionadorLinkServico.adicionarLink(dtos);
